sap.ui.define([
	"sap/ui/test/Opa5",
	"CreditDebit/UploadCreditDebitMemo/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel",
	"sap/ui/core/routing/HashChanger",
	"CreditDebit/UploadCreditDebitMemo/test/flpSandbox",
	"sap/ui/fl/FakeLrepConnectorLocalStorage"
], function(Opa5, mockserver, ODataModel, HashChanger, flpSandbox, FakeLrepConnectorLocalStorage) {
	"use strict";

	return Opa5.extend("CreditDebit.UploadCreditDebitMemo.test.integration.arrangements.Startup", {
		...
		iRestartTheAppWithTheRememberedItem : function (oOptions) {
			...
			this.waitFor({
				success : function() {
					oOptions.hash = "A_CreditMemoRequest/" + encodeURIComponent(sObjectId);
