		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Upload Credit Debit Memo Request",
									"targetURL": "#UploadCreditDebitMemoRequest-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"UploadCreditDebitMemoRequest-display": {
								"semanticObject": "UploadCreditDebitMemoRequest",
								"action": "display",
								"description": "Upload Credit Debit Memo Request",
								"title": "Upload Credit Debit Memo Request",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=CreditDebit.UploadCreditDebitMemo.Component",
									"url": sap.ui.require.toUrl("CreditDebit/UploadCreditDebitMemo")
								}
							}
						}
					}
